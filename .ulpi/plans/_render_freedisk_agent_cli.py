...
plan["tasks"] = [
    ...
    T(
        ...
        description=(
            ...
            "newer rebuildable belongs in Ask first. "
            "tmp children idle ≥ tmp_idle_days belong in Reclaimable; newer tmp children in Ask first; tmp roots (keep) do not. "
            "not_present rendered even when empty as a line."
        ),
        type="feature",
        priority="P1",
        effort="S",
